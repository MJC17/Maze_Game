...
// this is not my maze algorithm
// credit towards one of the answers on the post 'Simple Java 2d array maze sample' on stackoverflow.com (https://stackoverflow.com/questions/21815839/simple-java-2d-array-maze-sample/21818297)
// it was edited to soot my needs
...
public class MazeMaker {
    ...
    public MazeMaker(int aDimension) {
        // Initialize
        this(aDimension, aDimension);
    }
    // constructor
    public MazeMaker(int xDimension, int yDimension) {
        dimensionX = xDimension;
        dimensionY = yDimension;
        gridDimensionX = xDimension * 4 + 1;
        gridDimensionY = yDimension * 2 + 1;
        endPointX = dimensionX - 1;
        endPointY = dimensionY -1;
    ...
    public int[][] generateMaze() {
        return generateMaze(0, 0);
    }
    // generate the maze from coordinates x, y
    private int[][] generateMaze(int x, int y) {
        return generateMaze(getCell(x, y)); // generate from Cell
    }
    private int[][] generateMaze(Cell startAt) {
    ...
    public void updateGrid() {
        int backChar = 0, wallChar = 1, cellChar = 0, pathChar = 5;
        // fill background
